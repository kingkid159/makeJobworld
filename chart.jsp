...
<body>
	...
	<c:if test="${chartVO.job eq '웹프로그래머'}">
		<img src='${contextPath}/resources/image/시각화자료/${chartVO.job}_전체.png' alt="직종전체그래프">
		<%-- <img src='${contextPath}/resources/image/시각화자료/${chartVO.job}_${chartVO.jobDetail}_${chartVO.graphType}.png' alt="직무별그래프"> --%>
		<a href="${contextPath}/job/detailChart.do?job=웹프로그래머&jobDetail=jsp">jsp</a>
		<a href="${contextPath}/job/detailChart.do?job=웹프로그래머&jobDetail=백엔드">백엔드</a>
		<a href="${contextPath}/job/detailChart.do?job=웹프로그래머&jobDetail=웹개발">웹개발</a>
		<a href="${contextPath}/job/detailChart.do?job=웹프로그래머&jobDetail=자바">자바</a>
		<a href="${contextPath}/job/detailChart.do?job=웹프로그래머&jobDetail=프론트">프론트</a>
	</c:if>
	<c:if test="${chartVO.job eq '퍼블리싱UI개발'}">
		<img src='${contextPath}/resources/image/시각화자료/${chartVO.job}_전체.png' alt="직종전체그래프">
		<%-- <img src='${contextPath}/resources/image/시각화자료/${chartVO.job}_${chartVO.jobDetail}_${chartVO.graphType}.png' alt="직무별그래프"> --%>
		<a href="${contextPath}/job/detailChart.do?job=퍼블리싱UI개발&jobDetail=css">css</a>
		<a href="${contextPath}/job/detailChart.do?job=퍼블리싱UI개발&jobDetail=xml">xml</a>
		<a href="${contextPath}/job/detailChart.do?job=퍼블리싱UI개발&jobDetail=웹표준">웹표준</a>
		<a href="${contextPath}/job/detailChart.do?job=퍼블리싱UI개발&jobDetail=자바스크립">자바스크립</a>
		<a href="${contextPath}/job/detailChart.do?job=퍼블리싱UI개발&jobDetail=퍼블리셔">퍼블리셔</a>
	</c:if>
