...
public class ResumePage {
	...
	private List<ResumeVO> content;//게시글목록정보(글번호,제목,작성자,조회수,최초작성일,마지막수정일)
	...
	public ResumePage(int total, int currentPage, 
			   int size, List<ResumeVO> content) {
	this.total = total;
	...
	public List<ResumeVO> getContent() {
		return content;
	}

	public void setContent(List<ResumeVO> content) {
		this.content = content;
	}
