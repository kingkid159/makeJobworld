...
public class LetterVO {
	...
	public LetterVO(int lno, String lTitle, String qes1, String res1, String qes2, String res2, String qes3,
			String res3, String qes4, String res4, String qes5, String res5, String qes6, String res6,
			String imagefile) {
		this.lno = lno;
		this.lTitle = lTitle;
		this.qes1 = qes1;
	...
	public String toString() {
		return "LetterVO [lno=" + lno + ", lTitle=" + lTitle + ", qes1=" + qes1 + ", res1=" + res1 + ", qes2=" + qes2
				+ ", res2=" + res2 + ", qes3=" + qes3 + ", res3=" + res3 + ", qes4=" + qes4 + ", res4=" + res4
				+ ", qes5=" + qes5 + ", res5=" + res5 + ", qes6=" + qes6 + ", res6=" + res6 + ", imagefile=" + imagefile
				+ "]";
	}
